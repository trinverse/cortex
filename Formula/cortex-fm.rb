class CortexFm < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/trinverse/cortex/releases/download/v0.1.2/cortex-v0.1.2-aarch64-apple-darwin.tar.gz"
      sha256 "PENDING_MACOS_ARM64_SHA256"
    else
      # Intel Mac builds from source for now
      url "https://github.com/trinverse/cortex/archive/refs/tags/v0.1.2.tar.gz"
  ...
  test do
    assert_match "0.1.2", shell_output("#{bin}/cortex-fm --version")
  end
end